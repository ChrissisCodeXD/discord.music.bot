...
def Create_Service(client_secret_file, api_name, api_version, *scopes, logger, prefix=''):
    ...
    try:
        ...
        logger.critical(e)
        logger.critical(f'Failed to create service instance for {API_SERVICE_NAME}')
